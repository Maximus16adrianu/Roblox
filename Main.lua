...
local insults = {
    ...
    -- Sex Insults
    {"Your sex appeal is somewhere between a wet mop and a dead fish.", "Sex"},
...
local charMap = {
    ["a"] = "ａ",     -- Latin African A (Wide A ligature)
    ["b"] = "ƀ",     -- Latin B with stroke
    ["c"] = "ꞓ",     -- Reversed C with curl
    ["d"] = "ꝱ",     -- D with curl
    ["e"] = "е",     -- Yi syllable E
    ["f"] = "ғ",     -- Latin Capital F with stroke
    ["g"] = "ɡ",     -- G with hook
    ["h"] = "һ",     -- Cyrillic Short H
    ["i"] = "і",     -- Cyrillic Small I
    ["j"] = "ј",     -- Cherokee Letter Yu
    ["k"] = "ꝁ",     -- K with stroke
    ["l"] = "ꝉ",     -- L with high stroke
    ["m"] = "м",     -- Modified M
    ["n"] = "п",     -- N with descender
    ["o"] = "о",     -- O with stroke
    ["p"] = "ρ",     -- Reversed P
    ["q"] = "գ",     -- Cherokee Letter Quo
    ["r"] = "ɾ",     -- R with tail
    ["s"] = "ꜱ",     -- Small Capital S
    ["t"] = "t",     -- T with curl
    ["u"] = "ц",     -- Cherokee Letter U
    ["v"] = "ᵥ",     -- V with curl
    ["w"] = "ꝡ",     -- Latin Small Letter VY
    ["x"] = "ꭓ",     -- Cherokee Letter Ka
    ["y"] = "ᵧ",
    ["z"] = "z"    -- Z with curl
}
